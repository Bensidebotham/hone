            ...
            <CardHeader className="pb-2">
              <div className="flex items-start justify-between gap-1">
                ...
                <button
                  ...
                  className="hidden sm:flex shrink-0 cursor-grab touch-none items-center justify-center rounded p-0.5 text-muted-foreground/50 hover:text-muted-foreground active:cursor-grabbing focus-visible:outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50"
                >
