        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <button
              ...
              className="flex flex-col items-center gap-0 text-muted-foreground hover:text-foreground disabled:opacity-40 transition-colors focus-visible:outline-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 rounded"
            >
